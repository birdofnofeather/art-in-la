"""Museum of Latin American Art (MOLAA) — Squarespace events JSON API."""
...
BASE = "https://molaa.org"


def _ms_to_iso(ms) -> str | None:
    """Convert Squarespace millisecond timestamp to ISO 8601 string."""
    if not ms:
        return None
    try:
...
class Scraper(BaseScraper):
    ...
    source_label = "molaa.org"
    drop_exhibitions = False  # keep multi-day events
