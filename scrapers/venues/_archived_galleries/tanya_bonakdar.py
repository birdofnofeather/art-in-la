"""Tanya Bonakdar Gallery — Artlogic h2/h3 block, Los Angeles filter."""
...
BASE = "https://www.tanyabonakdargallery.com"
_DATE_RE = re.compile(
...
class Scraper(BaseScraper):
    venue_id = "tanya_bonakdar"
    events_url = f"{BASE}/exhibitions/"
    source_label = "tanyabonakdargallery.com"
    ...
    def custom_parse(self,html,base_url):
        ...
        for h2 in soup.find_all(["h2","h3"]):
            parent=h2.find_parent(["div","li","article"])
            ...
            a=parent.find("a",href=True); href=a["href"] if a else ""
