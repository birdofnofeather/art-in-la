"""Wilding Cran — Artlogic CMS, link-text inline date (D Mon - D Mon YYYY format)."""
...
BASE = "https://www.wildingcran.com"
...
class Scraper(BaseScraper):
    venue_id = "wilding_cran"
    events_url = f"{BASE}/exhibitions/"
    source_label = "wildingcran.com"
