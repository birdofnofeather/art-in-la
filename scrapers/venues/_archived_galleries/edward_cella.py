"""Edward Cella Art+Architecture — Artlogic CMS, link-text inline date."""
...
BASE = "https://edwardcella.com"
_EXHB_RE = re.compile(r"/exhibitions/\d+")

# Matches "Nov 11, 2023 - Jan 10, 2024" or "Sep 16 - Oct 28, 2023" or "May 27 - Jul 1, 2023"
_DATE_RE = re.compile(
...
class Scraper(BaseScraper):
    venue_id = "edward_cella"
    events_url = f"{BASE}/exhibitions/"
    source_label = "edwardcella.com"
