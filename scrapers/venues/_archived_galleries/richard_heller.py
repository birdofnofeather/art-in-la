"""richard_heller — Squarespace/HTML, article containers with inline date."""
...
BASE = "https://richardhellergallery.com"
_DATE_RE = re.compile(
...
class Scraper(BaseScraper):
    venue_id = "richard_heller"
    events_url = f"{BASE}/exhibitions"
    source_label = "richardhellergallery.com"
