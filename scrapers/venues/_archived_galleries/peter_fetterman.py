"""Peter Fetterman Gallery — Artlogic CMS, link-text inline date (D Mon - D Mon YYYY)."""
...
BASE = "https://www.peterfetterman.com"
...
class Scraper(BaseScraper):
    venue_id = "peter_fetterman"
    events_url = f"{BASE}/exhibitions/"
    source_label = "peterfetterman.com"
