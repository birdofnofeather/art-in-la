"""Shulamit Nazarian — Artlogic CMS, link-text inline date (Mon D - Mon D, YYYY)."""
...
BASE = "https://www.shulamitnazarian.com"
...
class Scraper(BaseScraper):
    venue_id = "shulamit_nazarian"
    events_url = f"{BASE}/exhibitions/"
    source_label = "shulamitnazarian.com"
